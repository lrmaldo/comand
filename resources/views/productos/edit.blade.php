...
<h1 class="mt-4">Editar Banner</h1>
                        ...
                        <form  role="form" method="POST" enctype="multipart/form-data" action="{{ route('home.update', $registro->id) }}">
              ...
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                  <div class="input-group-prepend">
                    ...
                    <div class="col-md-8">
                    <input type="text" id ="titulo" class="form-control" name="titulo" value="{{$registro->titulo}}" placeholder="Escribe un título" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group-prepend">
                      ...
                      <div class="col-md-8">
                      <input type="text" id ="precio" class="form-control" name="precio" value="{{$registro->precio}}" placeholder="Escribe una pequeña descripción" required>
                      </div>
                    </div>
...
<div class="modal fade" id="exampleModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <form class="form-horizontal" role="form" method="post" action="{{ url('/home/destroy/' . $registro->id ) }}">
