 ...
 <header class="masthead  text-white text-center">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
      @foreach ($carrusel as $key => $item1)
    <li data-target="#carouselExampleIndicators" data-slide-to="{{$item1->id}}" class="@if($key == 0)active @endif"></li>
    @endforeach
    </ol>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item @if($key==0) active @endif " style=" background-image: url('{{$item->url_imagen}}'); background-position: center;
        background-size: contain;" class="img-fluid">
...
<section class="page-section portfolio" id="portfolio">
  <div class="container">
      ...
      <div class="row">
          <!-- Portfolio Item 1-->
          {{-- modelo de vistas de productos --}}
          @foreach ($productos as $item)
          
          <div class="col-md-6 col-lg-4 mb-5">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal{{$item->id}}" data-id="{{$item->id}}">
                  <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                      <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                  </div>
                  <img class="img-fluid" style="height:300px; width:auto; margin:auto; display:block" src="{{$item->url_imagen}}" alt="" />
              </div>
          </div>
...
<section class="page-section bg-primary text-white mb-0" id="about">
  <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-white">Acerca de nosostros</h2>
      <!-- Icon Divider-->
      ...
      <div class="text-center mt-4"><p class="lead">{{$datos->descripcion}}</p></div>
