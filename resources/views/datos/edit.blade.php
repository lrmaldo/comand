        ...
        <div class="card-header py-3">
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('datos.update', $datos->id) }}">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-4">
                        ...
                        {{-- <button type="button" class="btn btn-danger btn-xs"
                            data-toggle="modal" data-target="#exampleModal"> <i class="far fa-trash-alt"></i>
                            Eliminar
                        </button> --}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="nombre" class="form-control" name="nombre" value="{{ $datos->nombre }}"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="telefono" class="form-control" name="telefono" value="{{ $datos->telefono }}"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="email" id="correo" class="form-control" name="correo" value="{{ $datos->correo }}"
                            required>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form class="form-horizontal" role="form" method="post"
                        action="{{ url('/bannerp/destroy/' . $registro->id) }}">
